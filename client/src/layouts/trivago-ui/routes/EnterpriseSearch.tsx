...
import { useDocumentTitle, useLocalize, TranslationKeys } from '~/hooks';
...
const EnterpriseSearch: React.FC = () => {
  ...
  // Set page title
  useDocumentTitle(`${localize('trivago_ui_enterprise_search' as TranslationKeys)} | LibreChat`);
        ...
        <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-semibold text-text-primary">
              {localize('trivago_ui_enterprise_search' as TranslationKeys)} --
            </h1>
          </div>
          <TooltipAnchor
        ...
        <div className="mx-auto max-w-5xl px-4 py-8">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder={localize(
                  'trivago_ui_enterprise_search_placeholder' as TranslationKeys,
                )}
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-lg border border-border-medium bg-surface-secondary p-6 transition-all hover:border-text-primary">
              ...
              <h3 className="mb-2 text-lg font-semibold text-text-primary">
                {localize('trivago_ui_conversation_search' as TranslationKeys)}
              </h3>
              <p className="text-sm text-text-secondary">
                {localize('trivago_ui_conversation_search_description' as TranslationKeys)}
              </p>
            </div>
            ...
            <div className="rounded-lg border border-border-medium bg-surface-secondary p-6 transition-all hover:border-text-primary">
              ...
              <h3 className="mb-2 text-lg font-semibold text-text-primary">
                {localize('trivago_ui_document_search' as TranslationKeys)}
              </h3>
              <p className="text-sm text-text-secondary">
                {localize('trivago_ui_document_search_description' as TranslationKeys)}
              </p>
            </div>
            ...
            <div className="rounded-lg border border-border-medium bg-surface-secondary p-6 transition-all hover:border-text-primary">
              ...
              <h3 className="mb-2 text-lg font-semibold text-text-primary">
                {localize('trivago_ui_ai_powered_search' as TranslationKeys)}
              </h3>
              <p className="text-sm text-text-secondary">
                {localize('trivago_ui_ai_powered_search_description' as TranslationKeys)}
              </p>
            </div>
          </div>
          ...
          <div className="mt-12">
            <h2 className="mb-4 text-lg font-semibold text-text-primary">
              {localize('trivago_ui_recent_searches' as TranslationKeys)}
            </h2>
            <div className="rounded-lg border border-border-medium bg-surface-secondary p-8 text-center">
              <p className="text-text-secondary">
                {localize('trivago_ui_no_recent_searches_yet' as TranslationKeys)}
              </p>
            </div>
          </div>
          ...
          <div className="mt-8">
            <h2 className="mb-4 text-lg font-semibold text-text-primary">
              {localize('trivago_ui_quick_actions' as TranslationKeys)}
            </h2>
            <div className="flex flex-wrap gap-3">
              <Button variant="outline" className="flex items-center gap-2">
                <Search className="h-4 w-4" />
                {localize('trivago_ui_advanced_search' as TranslationKeys)}
              </Button>
              <Button variant="outline" className="flex items-center gap-2">
                <FileSearch className="h-4 w-4" />
                {localize('trivago_ui_search_filters' as TranslationKeys)}
              </Button>
              <Button variant="outline" className="flex items-center gap-2">
                <Database className="h-4 w-4" />
                {localize('trivago_ui_export_results' as TranslationKeys)}
              </Button>
            </div>
          </div>
        </div>
